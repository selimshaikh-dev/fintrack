...
{
    public abstract class SqlDbContextBase<TEntity> where TEntity : class
    {
        private readonly SqlConnection _con;
        private SqlTransaction _trans;

        protected SqlDbContextBase(IConfiguration configuration)
        {
        ...
        public async Task<DateTime> GetDateTimeAsync(string sqlQuery, DynamicParameters parameter)
        {
            await using var connection = _con;
            try
            {
